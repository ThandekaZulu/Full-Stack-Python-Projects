# 212 Miles to Kilomiles Program
from tkinter import *

def button_clicked():
    miles = float(input_box.get())   # get miles from entry
    km = miles * 1.609             # convert miles to km
